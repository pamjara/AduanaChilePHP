    ...
    <h2>Estadìstivas</h2>
       ...
       <div class="col-sm-4">
        <div class="md-form-group float-label">
          <input type=date class="md-input" ng-model="fecha" required>
          <label>Desde</label>
        </div>
      </div>
     ...
     <div class="col-sm-4">
        ...
        <button type="submit" class="btn btn-primary m-t" >Buscar</button>
         <div>
         <button type="submit" class="btn btn-danger m-t">Eliminar</button>
         <button type="submit" class="btn btn-success m-t">Guardar</button>
         <button md-ink-ripple class="btn btn-fw btn-warning m-t">imprimir</button>
         </div>
